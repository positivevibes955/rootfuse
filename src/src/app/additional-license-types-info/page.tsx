          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="bg-dashboard-bg border-dashboard-border">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-dashboard-text font-digital">Cultivation</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-dashboard-bg border-dashboard-border">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-dashboard-text font-digital">Processing</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-dashboard-text/80 font-mono text-sm">
            ...
            <Card className="bg-dashboard-bg border-dashboard-border">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-dashboard-text font-digital">Dispensary</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-dashboard-text/80 font-mono text-sm">
          ...
          <Card className="bg-dashboard-bg border-dashboard-border mb-8">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold text-dashboard-text font-digital mb-2">Data Integration</h3>
                  <p className="text-dashboard-text/80 font-mono text-sm">
                    Seamlessly transfer data between license types. Track products from seed to sale across your entire operation.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-dashboard-text font-digital mb-2">Unified Dashboard</h3>
                  <p className="text-dashboard-text/80 font-mono text-sm">
                    Switch between license views instantly. Get a complete picture of your vertical integration.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-dashboard-text font-digital mb-2">Cost Savings</h3>
                  <p className="text-dashboard-text/80 font-mono text-sm">
                    Additional licenses are discounted. Save money while expanding your operational capabilities.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-dashboard-text font-digital mb-2">Compliance Sync</h3>
                  <p className="text-dashboard-text/80 font-mono text-sm">
                    Maintain compliance across all license types with automated reporting and tracking.
                  </p>
                </div>
              </div>
            </CardContent>
